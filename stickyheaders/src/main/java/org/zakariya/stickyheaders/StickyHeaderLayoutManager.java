...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
	...
	/**
	 * @param fullyVisibleOnly if true, the search will be limited to the last item not hanging off top of screen or partially obscured by a header
	...
	/**
	 * @param fullyVisibleOnly if true, the search will be limited to the last header not hanging off top of screen
	...
	/**
	 * @param fullyVisibleOnly if true, the search will be limited to the last footer not hanging off top of screen or partially obscured by a header
